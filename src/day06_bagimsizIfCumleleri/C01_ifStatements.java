...
public class C01_ifStatements {
    public static void main(String[] args) {
        ...
        kodumuz konsolda hicbir sey yazdirmasa da
        Process finished with exit code 0
        bu ifade kodumuzun dogru calistigini gosterir

        sadece degerler sartlari saglamadigi icin konsolda birsey yazdirilmadi
         */
        ...
        /*
        bazen if statement'da direkt boolean bir deger sart olarak yazilabilir
