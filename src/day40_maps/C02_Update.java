...
public class C02_Update {
    ...
    public static void main(String[] args) {
        ...
        // ogrencilerin siniflarini 1 artirin
        // eger 12. sinif varsa sinif bilgisi olarak mezun yazin

        // eger update varsa key ve value birlikte dusunulmelidir
        // ayni key'le yeni value 'yu map'e ekledigimizde
        // key unique olacagi icin eki value'yu update edip yeni value degerini kaydeder
