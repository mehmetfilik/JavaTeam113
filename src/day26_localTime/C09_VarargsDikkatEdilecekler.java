...
public class C09_VarargsDikkatEdilecekler {
    ...
    public static void main(String[] args) {
        ...
        topla(2,3,4,5,6,7); // Istenen islem sonucu : 50

        /* Dikkat edilmesi gereknler 2-
        son sayiyi ayirmak istesek?
            varargs eklenen tum paremetreleri kendisi almak ister
            bundan dolayi bir method'da parametre olarak
            varargs kullanilacaksa ,
            EN SON parametre olarak kullanilmalidir

           Dikkat edilecekler 3-
            bir method'da parametreolarak 2 varargs KULLANILAMAZ
    ...
    2 method icin de her ne kadar parametre sayisi farkli olsa da
