...
public class C02_NestedIfElse {
    ...
    public static void main(String[] args) {
        ...
        //birden fazla degiskene bagli if else statementlerini yazarken
        ...
        //distakine Outer if else,
        //ictekine Inner if else. deriz
        //Nested if else ic ice if else anlamina gelir.
        ...
        if (cinsiyet=='k' || cinsiyet=='K'){ //Kadin
            ...
            System.out.println("Gecersiz cinsiyet girisi, lutfen tekrar deneyin");
        }
