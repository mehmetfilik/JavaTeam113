...
public class C05_HashMapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // verilen key varsa value'sunu döndürür, yoksa null döndürür

        System.out.println(ornekMap.getOrDefault("M", 60)); // 20
        System.out.println(ornekMap.getOrDefault("Z", 60)); // 60
        // verilen key varsa value'sunu getirir yoksa verilen default degeri döndürür

        System.out.println(ornekMap.replace("M", 50)); // 20
        // verilen key varsa degerini update eder ve eski degeri döndürür
        ...
        // key'in degeri verilen deger degilse bir islem yapmaz ve false döndürür
